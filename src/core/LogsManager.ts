...
class LogsManager {
	...
	static error(message: string): void {
		console.log(
			`${this._getInfo() + bgRed(whiteBright(' ERROR '))} ${message}`,
		);
	}
	...
	static info(message: string): void {
		console.log(
			`${this._getInfo() + bgBlue(whiteBright(' INFO '))} ${message}`,
		);
	}
	...
	static success(message: string): void {
		console.log(
			`${this._getInfo() + bgGreen(whiteBright(' SUCCESS '))} ${message}`,
		);
	}
	...
	static status(message: string): void {
		console.log(
			`${
				this._getInfo() + bgMagenta(whiteBright(' STATUS '))
			} ${message}`,
		);
	}
	...
	static warning(message: string): void {
		console.log(
			`${
				this._getInfo() + bgYellow(whiteBright(' WARNING '))
			} ${message}`,
		);
	}
}
